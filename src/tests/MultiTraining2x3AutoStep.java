...
public class MultiTraining2x3AutoStep {
	...
	public static void main(String[] args) {
		...
		AutoStepParams as = new AutoStepParams();
		as.alphaInit = 999.999;
		as.tau = 1e4;
		as.mu = 0.001;
		par.lrPar = (LearningRateParams) as;
		...
		b1.addAll(MultiTrainingFactory.generateParamList("lrPar", "alphaInit", 0.0001, 0.0001, 0.001001));
		...
		mtp.multiTrainingBaseFolder = "C:/Users/Service/Documents/Results/2x3AutoStep";
		mtp.numRepeatsPerExperiment = 20;
		mtp.numParallelRuns = 4;
